    ...
    >
      <div className="card-inner">
        ...
        <div className="card-front">
          {/* <p className="card-title">Wish {id + 1}</p>  */}
          <svg className="h-20 w-20" 
            ...
            id="SVGRepo_iconCarrier"> <path opacity="0.5" 
